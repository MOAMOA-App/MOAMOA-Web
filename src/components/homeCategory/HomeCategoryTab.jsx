...
export default function HomeCategoryMob() {
    return (
        <div className={style.homeTabCatCont}>
            <div className={style.homeTabCatInfo}>
                <h2>카테고리</h2>                
            </div>
            <div className={style.homeTabCatBtnCont}>
                <div className={style.homeTabCatBtnCont2}>
                    <button className={style.homeTabCatBtnAll}>
                        <a href="/productlist">
                            <div className={style.homeTabCatLabelAll}>
